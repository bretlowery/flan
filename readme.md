...
| --nouatag | If specified, excludes the "Flan/v#(https://bret.guru/flan)" from the user agent values in the generated log files. | Append the Flan UA tag to all generated UAs. |
